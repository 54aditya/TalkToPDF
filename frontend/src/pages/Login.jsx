...
import { KeyRound, Mail, Sparkles, ArrowRight, AlertTriangle } from 'lucide-react'
...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-radial-gradient relative overflow-hidden px-4">
      ...
      <div className="w-full max-w-md glass rounded-2xl p-8 border border-slate-800 shadow-2xl relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-slate-400 mt-2">Sign in to search and discuss research papers</p>
        </div>
